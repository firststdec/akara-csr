...
var defineWellKnownSymbol = __webpack_require__(52);
...
var ArrayIteratorMethods = __webpack_require__(36);
var createNonEnumerableProperty = __webpack_require__(8);
var wellKnownSymbol = __webpack_require__(0);
...
var es_symbol_description = __webpack_require__(54);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.symbol.iterator.js
var es_symbol_iterator = __webpack_require__(55);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.from.js
var es_array_from = __webpack_require__(56);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.iterator.js
var es_array_iterator = __webpack_require__(36);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.array.slice.js
var es_array_slice = __webpack_require__(62);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.function.name.js
var es_function_name = __webpack_require__(63);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.object.to-string.js
var es_object_to_string = __webpack_require__(64);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.regexp.to-string.js
var es_regexp_to_string = __webpack_require__(65);

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.iterator.js
var es_string_iterator = __webpack_require__(66);

// EXTERNAL MODULE: ./node_modules/core-js/modules/web.dom-collections.iterator.js
var web_dom_collections_iterator = __webpack_require__(67);

// CONCATENATED MODULE: ./src/scripts/_variables.js
...
var breakpointMD = 897;
// CONCATENATED MODULE: ./src/scripts/_functions.js
...
var _functions_goToSection = function goToSection(element) {
  var targetId = element.getAttribute('href');
  var targetElmt = document.querySelector(targetId);
  var offsetTop = getOffsetTop(targetElmt);
  window.scrollTo({
    top: window.innerWidth >= breakpointMD ? offsetTop - document.querySelector('#gnav').offsetHeight : offsetTop,
    behavior: 'smooth'
  });
};
// CONCATENATED MODULE: ./src/scripts/modules/gnav.js
...
var gnav_Gnav = /*#__PURE__*/function () {
  function Gnav() {
  ...
  _createClass(Gnav, [{
    ...
    value: function stickyMenu() {
      ...
      window.addEventListener('scroll', function (e) {
        ...
        var start = problems.offsetTop - _this.gnav.offsetHeight;

        if (scrollTop >= start) {
          _this.gnav.classList.add(isFixed);
        } else {
          _this.gnav.classList.remove(isFixed);
        }
      });
    }
  }, {
    ...
    value: function openMenu() {
      ...
      setTimeout(function () {
        _this2.gnav.classList.add(isShow);
      }, 100);
    }
  }, {
    key: "closeMenu",
    value: function closeMenu() {
      ...
      setTimeout(function () {
        _this3.gnav.style.display = 'none';
      }, 100);
    }
  }, {
    key: "init",
    value: function init() {
      ...
      var gnavLinks = document.querySelectorAll('.c-gnav__link');

      var _iterator = _createForOfIteratorHelper(gnavLinks),
          _step;
...
// CONCATENATED MODULE: ./src/scripts/modules/arrow.js
...
function arrow_createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = arrow_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function arrow_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return arrow_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return arrow_arrayLikeToArray(o, minLen); }

function arrow_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var arrow_Arrow = /*#__PURE__*/function () {
  function Arrow(prop) {
  ...
  arrow_createClass(Arrow, [{
    ...
    value: function init() {
      if (this.arrows.length) {
        var _iterator = arrow_createForOfIteratorHelper(this.arrows),
            _step;
...
var gnav = new gnav_Gnav();
var scripts_arrow = new arrow_Arrow({
  target: '.c-arrow'
});
